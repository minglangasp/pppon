...
class ArchiveArctypeViewModel extends ViewModel {
   ...
   'arctype'=>array(
       'id'=>'arctype_id',
       'modelid'=>'arctype_modelid',
       'typename'=>'arctype_typename',
       'linkurl'=>'arctype_linkurl',
       'seotitle'=>'arctype_seotitle',
       'keywords'=>'arctype_keywords',
       'description'=>'arctype_description',
       'content'=>'arctype.content',
       'sortrank'=>'arctype_sortrank',
       'fid'=>'arctype_fid',
       'path'=>'arctype_path',
       'tempindex'=>'arctype_tempindex',
       'templist'=>'arctype_templist',
       'temparticle'=>'arctype_temparticle',
       'waptempindex'=>'arctype_waptempindex',
       'waptemplist'=>'arctype_waptemplist', 
       'waptemparticle'=>'arctype_waptemparticle',
       'display'=>'arctype_display',
       '_on'=>'archive.typeid=arctype.id',
       '_type'=>'LEFT'), 
